...
/// </summary>
public sealed class SnapForwardNote : Note, IPositionable, IPlayable, ICloneable
{
    ...
    public object Clone()
    {
        SnapForwardNote clone = new(new(Timestamp), Position, Size, BonusType, JudgementType)
        {
