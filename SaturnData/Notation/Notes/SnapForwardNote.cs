...
/// </summary>
public class SnapForwardNote : Note, ITimeable, IPositionable, IPlayable
{
    ...
    public SnapForwardNote(Timestamp timestamp, int position, int size, BonusType bonusType, bool isJudgeable)
    {
        Timestamp = timestamp;
        Position = position;
        Size = size;
